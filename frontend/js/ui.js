...
export const renderRecipeCard = (recipe) => {
	...
	const imageUrl = recipe.image || "https://images.pexels.com/photos/5190684/pexels-photo-5190684.jpeg"
				...
				<div class="card-body d-flex flex-column">
					...
					<div class="mt-auto d-flex flex-column gap-2">
						...
						<div class="d-flex gap-2">
							<button class="btn btn-outline-secondary btn-sm flex-grow-1 btn-edit-recipe" data-recipe-id="${recipe.id}">
								Modifier
							</button>
							<button class="btn btn-outline-danger btn-sm flex-grow-1 btn-delete-recipe" data-recipe-id="${recipe.id}">
								Supprimer
							</button>
						</div>
					</div>
...
export const renderSingleRecipe = (recipe) => {
	...
	<div class="row">
		<div class="col-12">			
			...
			<img src="${imageUrl}" class="card-img-top" alt="${recipe.name}" style="max-height: 300px; object-fit: cover;">
